...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/imoveapp)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/imoveapp
```

A live public deployment of this template is available at [https://imoveapp.templates.workers.dev](https://imoveapp.templates.workers.dev)
